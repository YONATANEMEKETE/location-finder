...
const LocationCard = ({ location, onSelect }: LocationCardProps) => {
  return (
    <div
      className="bg-slate-50 dark:bg-slate-900 rounded-lg p-2 border border-slate-200 dark:border-slate-700 hover:shadow-md transition-all duration-200 group cursor-pointer"
      onClick={onSelect}
    >
